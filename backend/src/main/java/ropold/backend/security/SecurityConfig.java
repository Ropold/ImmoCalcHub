    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(a -> a
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/immo-calc-hub/no-login").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/me/role").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/users/me/my-real-estates/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/mbox/**").permitAll()
