...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=bugs)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=coverage)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-backend&metric=sqale_index)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-backend)
...
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=bugs)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=coverage)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ropold_ImmoCalcHub-frontend&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ropold_ImmoCalcHub-frontend)
